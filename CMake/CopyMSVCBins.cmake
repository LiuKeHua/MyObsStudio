...
option(Out_copying_info "" OFF)


SET(FFMPEG_avcodec_INCLUDE_DIR ${THIRDPARTY_INCLUDE_DIR})
SET(FFMPEG_avformat_INCLUDE_DIR ${THIRDPARTY_INCLUDE_DIR})
SET(FFMPEG_avutil_INCLUDE_DIR ${THIRDPARTY_INCLUDE_DIR})
SET(FFMPEG_avdevice_INCLUDE_DIR ${THIRDPARTY_INCLUDE_DIR})
SET(FFMPEG_avfilter_INCLUDE_DIR ${THIRDPARTY_INCLUDE_DIR})
SET(FFMPEG_postproc_INCLUDE_DIR ${THIRDPARTY_INCLUDE_DIR})
SET(FFMPEG_swscale_INCLUDE_DIR ${THIRDPARTY_INCLUDE_DIR})
SET(FFMPEG_swresample_INCLUDE_DIR ${THIRDPARTY_INCLUDE_DIR})
SET(FFMPEG_avcodec_INCLUDE_DIR ${THIRDPARTY_INCLUDE_DIR})
SET(X264_INCLUDE_DIR ${THIRDPARTY_INCLUDE_DIR})
SET(Libfdk_INCLUDE_DIR ${THIRDPARTY_INCLUDE_DIR})
SET(ZLIB_INCLUDE_DIR ${THIRDPARTY_INCLUDE_DIR})
SET(CURL_INCLUDE_DIR ${THIRDPARTY_INCLUDE_DIR})
SET(SSL_INCLUDE_DIR ${THIRDPARTY_INCLUDE_DIR})
