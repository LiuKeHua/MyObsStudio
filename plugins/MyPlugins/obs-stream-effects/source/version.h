...
const uint16_t PROJECT_VERSION_MAJOR	= 1;
const uint16_t PROJECT_VERSION_MINOR	= 18;
const uint16_t PROJECT_VERSION_PATCH	= 3;
const uint16_t PROJECT_VERSION_TWEAK	= 0;
...
const uint16_t PLUGIN_VERSION_MAJOR	= 1;
const uint16_t PLUGIN_VERSION_MINOR	= 18;
const uint16_t PLUGIN_VERSION_PATCH	= 3;
